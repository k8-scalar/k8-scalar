...
# Install MiniKube
curl -Lo minikube https://storage.googleapis.com/minikube/releases/v1.24.0/minikube-darwin-amd64 && chmod +x minikube && sudo mv minikube /usr/local/bin/
# Start MiniKube
minikube start --cpus 4 --memory 8192 --kubernetes-version=v1.14.0
...
# Install minikube
curl -LO https://storage.googleapis.com/minikube/releases/v1.24.0/minikube-windows-amd64.exe && mv minikube-windows-amd64.exe minikube.exe && export PATH=$PATH:`pwd`
minikube start --cpus 4 --memory 8192  --kubernetes-version=v1.14.0
```
