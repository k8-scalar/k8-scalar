...
if [ $1 == --delete ]; then
    ...
    kubectl delete -f mt-api-v1/templates/db-s.yaml
    kubectl delete -f mt-api-v1/templates/db.yaml
    kubectl delete -f mt-api-v1/templates/mt-api-s.yaml
    kubectl delete -f mt-api-v1/templates/mt-api.yaml
#    kubectl delete deployment mongo-db
#    kubectl delete deployment mt-api-v1
    kubectl delete deployment mt-api-v2
    helm uninstall exp-cont-0 api-v2
    sleep 20
else
