...
Wong et al.~\citep{hyscale} describes the (dis)advantages of vertical and horizontal scaling and proposes a hybrid solution, developed on top of Docker engine without any container orchestration framework. 
